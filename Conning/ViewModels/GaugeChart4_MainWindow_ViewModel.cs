...
{
    public class GaugeChart4_MainWindow_ViewModel : ViewModelBase
    {
        private GaugeChart4_MainWindow_Model model;
        public Double Value
        {
            get
            {
        ...
        public GaugeChart4_MainWindow_ViewModel()
        {
            model = new GaugeChart4_MainWindow_Model();
